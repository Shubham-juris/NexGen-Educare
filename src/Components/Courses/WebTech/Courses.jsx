...
const Courses = () => {
  ...
  return (
    ...
    <div data-aos="fade-right" className="p-4 bg-yellow-100 rounded-lg shadow-md">
        <WebTechCoursesCards />
      </div>
      <div data-aos="fade-up" className="p-4 bg-blue-100 rounded-lg shadow-md">
        <AccountsCoursesCards />
      </div>
      <div data-aos="fade-left" className="p-4 bg-green-100 rounded-lg shadow-md">
        <CompetitiveCoachingCards />
      </div>
      <div data-aos="fade-right" className="p-4 bg-yellow-100 rounded-lg shadow-md">
        <CoachingClassesCards />
      </div>
      <div data-aos="zoom-in" className="p-4 bg-pink-100 rounded-lg shadow-md">
        <CookingClassesCards />
      </div>
      <div data-aos="zoom-out" className="p-4 bg-purple-100 rounded-lg shadow-md">
        <HospitalistCoursesCards />
      </div>
      <div data-aos="flip-up" className="p-4 bg-teal-100 rounded-lg shadow-md">
        <LanguagesCoursesCards />
      </div>
      <div data-aos="flip-down" className="p-4 bg-orange-100 rounded-lg shadow-md">
